...
//FILENAME: CSE110Lab8.5
//SPECIFICATION: Calendar program
//FOR: CSE 110 - Lab #8
//TIME SPENT: 60 mins
//-----------------------------------------------------------*/
...
public class Lab8
{
    public static void main(String[] args)
    {
        ...
        for(int dayI = weekDay; dayI < numOfDays + weekDay; dayI++) {
        	//Need to find out which cell the dayI belongs to
        	calendar[(dayI-1) / 7][(dayI - 1) % 7] = String.valueOf(dayI - weekDay + 1);
        }
        /**
